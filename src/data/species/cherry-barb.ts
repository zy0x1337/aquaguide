      ...
      rules: [
        {
          ...
          reason: 'CRITICAL: Too many males = females get HARASSED TO DEATH. Males chase females relentlessly for breeding. If ratio is wrong (e.g., 6 males, 2 females), the 2 females get chased 24/7, become exhausted, stop eating, and DIE from stress. ALWAYS keep 2-3 females per male. Example: 2 males + 6 females = happy tank',
          severity: 'critical',
        },
        {
          type: 'avoid',
