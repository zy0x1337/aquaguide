...
export const blackSkirtTetra: Species = {
  ...
  funFact: "Black Skirt Tetras are the 'elegant goths' of the aquarium world—stunning fish with flowing black 'skirts' (anal fins) that billow like Victorian mourning dresses. But don't let their graceful appearance fool you! Young Black Skirts have a nippy reputation—they're the aquarium equivalent of moody teenagers who pinch people for fun. The good news? Fin-nipping behavior disappears in large groups (10+) and mature adults (1+ year). Keep them properly and watch them transform from bratty nippers into peaceful schooling beauties. Their black coloration fades with age (like goth kids who discover pastels), turning silvery-grey—it's natural, not illness!",
  ...
  behavior: {
    ...
    minGroupSize: 10,
    description: 'Black Skirt Tetras are active, graceful schoolers with a complicated reputation. In large groups (10+), they\'re peaceful, elegant fish that swim in synchronized formations like aquatic ballet dancers. Their flowing "skirts" (anal fins) billow beautifully as they glide through planted tanks. HOWEVER: in small groups (under 8), they become nippy bullies—chasing tankmates, nipping fins, and causing chaos. This is stress behavior, not inherent aggression. Think of them as insecure teenagers: confident in large friend groups, anxious bullies when isolated. Juveniles (under 1 year) are especially nippy even in large groups—it\'s a phase they outgrow. Mature adults (1+ years) in proper group sizes (10+) are peaceful and community-safe. They establish loose hierarchies within schools but rarely serious fighting. Most active during feeding time, zooming around midwater in tight formations.',
    ...
    compatibility: {
      ...
      notes: 'Black Skirt Tetras have a mixed reputation in community tanks. Reality: They\'re excellent community fish IF kept in groups of 10+ and paired with fast-moving or robust tankmates. Avoid pairing with long-finned slow fish (Angelfish, Bettas, Fancy Guppies)—young Black Skirts will nip flowing fins, causing stress and injuries. They\'re safe with short-finned fast fish (Danios, Barbs, other Tetras) and bottom-dwellers (Corydoras). As they mature (1+ years), fin-nipping behavior decreases significantly. Key: large groups + appropriate tankmates = peaceful schooling beauty.',
      ...
      rules: [
        ...
        },
        {
          ...
          reason: 'CRITICAL for reducing aggression. Groups under 8 = stressed, nippy bullies. Groups of 10+ = confident, peaceful schoolers. Fin-nipping behavior drops dramatically in large schools. 8 is minimum; 10-15 is ideal',
          severity: 'high',
        },
        {
          type: 'warning',
          target: 'juvenile Black Skirts with any slow fish',
          reason: 'Juveniles (<1 year) are especially nippy even in large groups. If keeping with slower tankmates, buy adult Black Skirts (1+ years old) which are calmer. Or accept that young ones will be bratty for 6-12 months',
          severity: 'medium',
        },
        {
          type: 'requires',
  ...
  care: {
    ...
    proTips: [
      "FIN-NIPPING SOLUTION: Groups of 10-15+ fish = peaceful behavior. Groups under 8 = stressed bullies. It's that simple. Larger schools diffuse aggression by spreading it across more targets. Single aggressive fish becomes background noise in group of 15.",
      ...
      "Long-fin variety is gorgeous but ironic—they're fin-nippers with giant fins! Long-fins are more vulnerable to bullying from standard Black Skirts. Keep long-fin groups separate or expect damaged fins.",
      ...
      "Dark substrate + tannins = stunning contrast. Black sand or dark gravel makes their black bodies pop. Add driftwood or Indian Almond leaves for amber-tinted water—mimics wild habitat and intensifies colors.",
    ],

    commonMistakes: [
      "Small groups (under 8) = #1 mistake. Stressed Black Skirts become nippy terrors. Groups of 3-5 create bullying hierarchies with constant harassment. Buy 10-15 fish minimum for peaceful behavior. Yes, it's more expensive upfront, but it prevents bloodbaths.",
      ...
      "Panicking over color fading. 'My Black Skirts are turning grey! Are they sick?' No. This is normal aging (like humans greying). Juveniles are black; adults fade to grey/silver. It's genetics, not disease. Embrace the silver fox stage!",
    ...
    feeding: {
      ...
      supplements: ['daphnia', 'spirulina', 'vegetables'],
      vegetarian: false,
      liveFood: {
        required: false,
        recommended: true,
    ...
    maintenance: {
      ...
      notes: 'Weekly 30% water changes maintain water quality. Black Skirts are messy eaters and produce moderate waste in large groups. Vacuum substrate weekly. Keep nitrates below 20ppm for best health and color retention.',
    },
  ...
  scientificContext: {
    wildHabitat: "Black Skirt Tetras inhabit slow-moving, heavily shaded forest streams and tributaries in the Paraguay River Basin (Brazil, Bolivia, Argentina). These are tannin-stained, soft-water habitats with muddy substrates, dense aquatic vegetation, submerged roots, and thick leaf litter. Water is warm (23-27°C), soft (GH 3-8), slightly acidic (pH 6.0-7.0), and dim due to forest canopy. They school in large groups (50-100+) for protection from predators, explaining why small aquarium groups cause stress. Wild specimens are more intensely black than domesticated strains.",
  ...
  breeding: {
    ...
    difficulty: 'beginner',
    trigger: 'Black Skirt Tetras are easy to breed—one of the best beginner egg-layers! Trigger spawning with: 1) Soft, slightly acidic water (pH 6.0-6.5, GH 4-8), 2) Large (40-50%) water change with slightly cooler water (22-23°C) to simulate rainy season, 3) Conditioning with high-protein live/frozen foods (bloodworms, brine shrimp, daphnia) for 2 weeks until females visibly plump. Separate sexes during conditioning, then introduce to spawning tank together.',
    fryCare: 'Females scatter 300-500 adhesive eggs among fine-leaved plants (Java Moss, spawning mops) or substrate. No parental care—adults eat eggs immediately. Remove adults after spawning. Eggs hatch in 24-36 hours at 24-26°C into tiny larvae. Fry become free-swimming at 3-5 days. Feed infusoria or liquid fry food initially, then baby brine shrimp after 1 week. Fry are tiny and grow slowly: 1cm at 4 weeks, 2cm at 8 weeks. Separate by size to prevent cannibalism. Maturity at 6-8 months.',
    notes: 'Black Skirt Tetras breed readily and prolifically in home aquariums. The challenge isn\'t spawning (easy) but raising hundreds of fry (labor-intensive). Many breeders let nature take its course in heavily planted tanks—some fry survive to adulthood on their own. For deliberate breeding, use separate spawning tank with spawning mops or Java Moss, condition breeders well, and remove adults immediately post-spawn.',
  },
