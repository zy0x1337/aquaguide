...
export const TankBuilderPage = () => {
  ...
  const getItemStyle = (realSizeCM: number, itemType: 'fish' | 'plant' | 'hardscape') => {
    ...
    if (itemType === 'plant') {
        // Assume plant width is ~40% of its height for visual representation
        // This prevents plants from being too wide squares
        ...
        // Fish
        widthPercent = (realSizeCM / tankL) * 100;
        // Adjust aspect ratio for fish to be slightly rectangular (longer) if needed, 
        // but 1:1 container with object-contain is safest for varying fish shapes
        aspectRatio = '1/1'; 
    }
