    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/20">
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base text-slate-600 font-semibold">Loading your tanks...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/20">
        <div className="text-center max-w-md mx-auto px-4">
          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-red-100 rounded-full mx-auto mb-4 flex items-center justify-center">
            <Fish className="w-6 h-6 sm:w-8 sm:h-8 text-red-600" />
          </div>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">Oops!</h2>
          <p className="text-sm sm:text-base text-slate-600 mb-6">{error}</p>
          <button
            onClick={loadTanks}
            className="bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-indigo-700 transition-colors text-sm sm:text-base"
          >
            Try Again
          </button>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold mb-2">My Tanks</h1>
              <p className="text-sm sm:text-base text-indigo-200">Manage your aquarium collection</p>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                to="/dashboard"
                className="hidden sm:flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg font-semibold transition-all text-sm"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 bg-white text-indigo-600 px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold hover:bg-indigo-50 transition-all shadow-lg hover:shadow-xl text-sm sm:text-base"
              >
          ...
          {tanks.length > 0 && (
            ...
            >
              ...
              />
              <StatCard
                icon={<Fish className="w-4 h-4 sm:w-5 sm:h-5" />}
                label="Fish Species"
        ...
        {tanks.length === 0 ? (
          ...
          >
            <div className="max-w-md mx-auto">
              <div className="w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-3xl mx-auto mb-6 flex items-center justify-center">
                <Fish className="w-12 h-12 sm:w-16 sm:h-16 text-indigo-600" />
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-3">No Tanks Yet</h2>
              <p className="text-sm sm:text-base text-slate-600 mb-8 leading-relaxed px-4">
                Start your aquarium journey by adding your first tank.
                Track inhabitants, water parameters, and maintenance schedules.
              </p>
              <button
                onClick={() => setIsModalOpen(true)}
                className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold hover:shadow-xl transition-all text-sm sm:text-base"
              >
                <Plus className="w-4 h-4 sm:w-5 sm:h-5" />
                Add Your First Tank
              </button>
