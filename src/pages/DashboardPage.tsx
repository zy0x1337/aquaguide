...
const DashboardPage = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/20">
        <div className="text-center">
          ...
          <p className="text-slate-600 font-semibold text-sm sm:text-base">Loading dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/20">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-sm sm:text-base text-indigo-200">Your aquarium analytics at a glance</p>
          </div>
        </motion.header>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/20">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <Link
              to="/my-tanks"
              className="hidden sm:flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-xl font-semibold transition-all"
            >
              View All Tanks
      ...
      {/* Main Content */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-12 space-y-6 sm:space-y-8">
        {/* Stats Overview */}
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Tank Health</h2>
              <Link
                to="/my-tanks"
                className="text-indigo-600 hover:text-indigo-700 font-semibold text-xs sm:text-sm flex items-center gap-1"
              >
                View Details
