    ...
    <div className="relative group">
      <Link 
        ...
        className={cn(
          ...
          "shadow-sm hover:shadow-2xl dark:shadow-none transition-all duration-500 ease-out",
          "border border-slate-100 dark:border-stone-800",
          "hover:-translate-y-1 hover:border-indigo-200 dark:hover:border-indigo-500/30",
          "focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none block"
        )}
